                ...
                <form action="{{ route($route.'.store') }}" method="post" role="form" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                <input type="text" name="keterangan" placeholder="Keterangan {{ucfirst($route)}}" id="keterangan" class="form-control  {{$errors->has('keterangan') ? 'form-control is-invalid' : 'form-control'}}" value="{{old('keterangan')}}" required>
                            </div>
