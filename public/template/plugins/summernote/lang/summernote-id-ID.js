(function($) {
  $.extend($.summernote.lang, {
    'id-ID': {
      ...
      table: {
        table: 'Tabel',
        addRowAbove: 'Createkan baris ke atas',
        addRowBelow: 'Createkan baris ke bawah',
        addColLeft: 'Createkan kolom ke kiri',
        addColRight: 'Createkan kolom ke kanan',
        delRow: 'Hapus baris',
        delCol: 'Hapus kolom',
      ...
      shortcut: {
        ...
        extraKeys: 'Shortcut Createan',
      },
      help: {
        'insertParagraph': 'Createkan paragraf',
        ...
        'formatPara': 'Edit format gaya tulisan terpilih menjadi paragraf',
        'formatH1': 'Edit format gaya tulisan terpilih menjadi Heading 1',
        'formatH2': 'Edit format gaya tulisan terpilih menjadi Heading 2',
        'formatH3': 'Edit format gaya tulisan terpilih menjadi Heading 3',
        'formatH4': 'Edit format gaya tulisan terpilih menjadi Heading 4',
        'formatH5': 'Edit format gaya tulisan terpilih menjadi Heading 5',
        'formatH6': 'Edit format gaya tulisan terpilih menjadi Heading 6',
